...
import misClases.Calificacion;
import misClases.Conductor;
import misClases.Muber;
import misClases.Pasajero;
import misClases.Viaje;
...
public class DBLoader {
	...
	private static Muber persistirModelo() throws Exception {
		...
		Calificacion califMargarita = new Calificacion(viaje1, 4, "Me senti muy a gusto, ningun problema. Super recomendable.", Margarita);
